...
# Get params
board_params = utils.get_charuco_board_parameters()
paper_params = utils.get_paper_parameters(orientation)

# Compute board size in pixels
board_length_pixels = board_params['squares_x'] * board_params['square_length_pixels']
board_width_pixels = board_params['squares_y'] * board_params['square_length_pixels']
...
board = cv2.aruco.CharucoBoard_create(
    ...
    board_params['square_length'], board_params['marker_length'],
    cv2.aruco.Dictionary_get(board_params['dict_id'])
)
scale_factor = (board_length_mm / paper_params['mm_per_in']) * paper_params['ppi'] / board_length_pixels
